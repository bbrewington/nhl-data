...
from utility.aws import run_s3_upload_fileext

run_s3_upload_fileext(data_dir=DATA_DIR, file_ext="parquet")

################################
# ORIGINALLY IN WRITE_TO_S3.PY #
################################
...
#         upload_file(file_path=file, bucket_name=S3_BUCKET, dest_object_name=dest_object_name, verbose=True)
